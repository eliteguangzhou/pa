...
*/
  ...
  if ($is_member) {
    $query = tep_db_query('SELECT DATE_FORMAT(expiration_date, "%d/%m/%Y") as date FROM '.TABLE_MEMBERS.' WHERE customers_id = '.$customer_id.' LIMIT 0,1');
    $expiration_date = tep_db_fetch_array($query);
...
?>
      <tr>
        <td><?php echo sprintf(EXPIRATION_MEMBER, $expiration_date); ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>

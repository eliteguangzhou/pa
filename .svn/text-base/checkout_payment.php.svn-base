...
// Stock Check
  if ( (STOCK_CHECK == 'true') && (STOCK_ALLOW_CHECKOUT != 'true') ) {
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      if (!$cart->is_card($products[$i]['id']) && tep_check_stock($products[$i]['id'], $products[$i]['quantity'])) {
        tep_redirect(tep_href_link(FILENAME_SHOPPING_CART));
        break;
      }
    }
          ...
          <tr class="infoBoxContents">
            <td><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td class="main" align="right"><input type="image" src="<?php echo DIR_WS_LANGUAGES.$language.'/images/buttons/payerlacommande.gif';?>" alt="Paypal" /><!--<input type="image" src="https://www.paypal.com/fr_FR/i/btn/btn_xpressCheckout.gif" alt="Paypal" />--></td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table></td>
          </tr>

...
<?php
	...
	$name_prod = '<span><a href="' . $random_product['products_id'] . '-p-'.str_replace(' ','_',$random_product['products_name']) . '-'.str_replace(' ','_',$product['products_description'] ) . '.html">' . $random_product['products_name'] . '</a></span>';

...
// The HTML href link wrapper function
  function tep_href_link($page = '', $parameters = '', $connection = 'NONSSL', $add_session_id = true, $search_engine_safe = true, $no_disable = false) {
    global $request_type, $session_started, $SID, $disable_links;
...
// Add the session ID when moving from different HTTP and HTTPS servers, or when SID is defined
    ...
    return !$no_disable && isset($disable_links) && $disable_links === true ? $_SERVER['PHP_SELF'].'#' : $link;
  }

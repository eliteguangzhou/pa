...
// class methods
    ...
    function before_process() {
      global $cart, $order, $sendto, $ppe_token, $ppe_payerid, $HTTP_POST_VARS, $comments, $easy_discount, $nb_products_discount, $check_server, $paypal_lang;

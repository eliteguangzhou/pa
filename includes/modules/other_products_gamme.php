     ...
     //new contentBoxHeading($info_box_contents);
      ...
      while ($orders = tep_db_fetch_array($product_info_query)) {
        ...
        $info_box_contents[$row][$col] = array('align' => 'center',
                                               ...
                                               '</a><br><a href="' . $orders['products_id']. '-p-'.str_replace('#','',str_replace(' ','_',$orders['products_name'])) .  '-'.str_replace('#','',str_replace(' ','_',$orders['products_description'])) . '.html">' . $orders['products_name'] . '</a>');

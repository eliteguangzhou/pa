...
?>
          <tr>
            ...
            <td class="main"><?php echo tep_draw_input_field('digicode', $entry['entry_digicode']) . '&nbsp;' . (tep_not_null(ENTRY_DIGICODE_TEXT) ? '<span class="inputRequirement">' . ENTRY_DIGICODE_TEXT . '</span>': ''); ?></td>
          </tr>
          <tr>

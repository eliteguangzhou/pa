...
//  new contentBoxHeading($info_box_contents);
  ...
  $p_pic = '<a href="' . $new_products['products_id'] . '-p-'.str_replace('#','',str_replace(' ','_',$new_products['products_name'])) . '-'.str_replace('#','',str_replace(' ','_',$new_products['products_description'] )) .  '.html">' . tep_image(DIR_WS_PWS_IMAGE . $new_products['products_image'], $new_products['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>';

  $p_desc = ''.substr(strip_tags($new_products['products_description']), 0, MAX_DESCR_1).' ...';

  $p_name = '<a href="' . $new_products['products_id'] . '-p-'.str_replace('#','',str_replace(' ','_',$new_products['products_name'])).  '-'.str_replace('#','',str_replace(' ','_',$new_products['products_description'])) . '.html">' .display_product_name($new_products['products_name'] , $new_products).'</a>';

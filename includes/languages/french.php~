...
define('BOX_HEADING_SPECIALS', 'Sp&eacute;cial No&euml;l');
...
define('JS_REVIEW_TEXT', '* Le \'commentaire\' que vous avez entr&eacute; doit avoir au moins ' . REVIEW_TEXT_MIN_LENGTH . ' caract&eacute;res.\n');
...
define('ENTRY_FIRST_NAME_ERROR', 'Votre pr&eacute;nom doit contenir un minimum de ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' caract&eacute;res.');
define('ENTRY_FIRST_NAME_TEXT', '*');
define('ENTRY_LAST_NAME', 'Nom :');
define('ENTRY_LAST_NAME_ERROR', 'Votre nom doit contenir un minimum de ' . ENTRY_LAST_NAME_MIN_LENGTH . ' caract&eacute;res.');
...
define('ENTRY_EMAIL_ADDRESS_ERROR', 'Votre adresse email doit contenir un minimum de ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' caract&eacute;res.');
...
define('ENTRY_STREET_ADDRESS_ERROR', 'Votre adresse doit contenir un minimum de ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' caract&eacute;res.');
...
define('ENTRY_POST_CODE_ERROR', 'Votre code postal doit contenir un minimum de ' . ENTRY_POSTCODE_MIN_LENGTH . ' caract&eacute;res.');
...
define('TEXT_GREETING_PERSONAL', 'Bienvenue <span class="greetUser">%s!</span> Voudriez vous voir quels <a href="%s"><u>nouveaux produits</u></a> sont disponibles &agreve; la vente ?');
...
define('CARD_DESC_CARD1', 'Faites vos achats &agrave; prix co&ucirc;tant durant 6 mois !');
define('CARD_NAME_CARD2', 'Abonnement 3 mois');
define('CARD_DESC_CARD2', 'Faites vos achats &agrave; prix co&ucirc;tant durant 3 mois !');
define('CARD_NAME_CARD3', 'Abonnement 12 mois');
define('CARD_DESC_CARD3', 'Faites vos achats &agrave; prix co&ucirc;tant durant 12 mois !');
...
define('MEMBER_CARD4', '<span class="bigger">- <span class="pink bold">Membre JUNIOR</span> : Carte membre (validit&eacute; '.$cards->list['card4']['duration'].' mois) : <span class="red bold">Offerte</span> </span><span class="bold small">(Offre valable jusqu\'au 15 septembre)</span>');
...
define('PRODUCTS_NOT_TOGETHER2', 'Vous ne pouvez pas acheter de carte en m&ecirc;me temps que des produits');
...
<br /><br />
En adh&eacute;rant au Club <span class="pink">'.STORE_NAME.'</span>, vous pouvez acheter &agrave; Prix Club <span class="bold">20 000 produits de beaut&eacute;</span> &agrave; prix co&ucirc;tant ! (<b>500 grandes marques de parfums</b>).
<br /><br />
Vous payez vos parfums &agrave; prix co&ucirc;tant ! <span class="bold">Z&eacute;ro frais de structure, Z&eacute;ro frais marketing, Z&eacute;ro taxes</span>... et rien d\'autre !
<br />Pour la premi&eacute;re fois, vous payez le prix juste. Nous nous r&eacute;mun&eacute;rons uniquement sur la formule d\'adh&eacute;sion de nos membres.
<br /><br />
Soit <span class="bold">70% d\'&eacute;conomie</span> en moyenne par rapport au prix pratiqu&eacute; en boutique. 
<br /><br />
Nos h&ocirc;tesses sont &agrave; votre service pour r&eacute;pondre &agrave; toutes vos questions : <a href="mailto:'.STORE_OWNER_EMAIL_ADDRESS.'">'.STORE_OWNER_EMAIL_ADDRESS.'</a>
<br /><br />
La shopping r&eacute;volution est en marche&hellip; rejoignez le mouvement !<br />');

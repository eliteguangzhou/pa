...
define('MEMBER_CARD4', '<span class="bigger">- <span class="pink bold">Membre JUNIOR</span> : Carte membre (validit&eacute; '.$cards->list['card4']['duration'].' mois) : <span class="red bold">Offerte</span> </span><span class="bold small">(Offre valable jusqu\'au 15 aout)</span>');

...
define('MY_SPONSORSHIP_TITLE', 'Sponsoring');
define('MY_SPONSORSHIP_ADD', 'Empfehlen Sie einen Freund');
define('MY_SPONSORSHIP_LIST', 'Meine Patenkinder');
define('MY_SPONSORSHIP_DISCOUNT', 'Meine Schnitte');
?>

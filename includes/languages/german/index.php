...
if ( ($category_depth == 'products') || (isset($HTTP_GET_VARS['manufacturers_id'])) ) {
  ...
  define('TEXT_PRICE_FROM', 'Ab dem');
} elseif ($category_depth == 'top') {
  define('HEADING_TITLE', 'Zu entdecken...');
} elseif ($category_depth == 'nested') {
  define('HEADING_TITLE', 'Kategorien');
}

define('NEW_INTRO','<h2 style="font-size:17px;margin-bottom:10px;">Parfümerie Angebot</b></h2>
Willkommen im Reich der geheimen Parfüm!

Spazieren Sie in den Duft <span class="text_rose">der billigsten Marke</span>
Kaufen Sie nicht ohne einen Vergleich mehr !<span class="text_rose"> Wir erstatten die Differenz !</span>

" <a class="text_rose" href="'.tep_href_link(FILENAME_ADVANTAGES).'">Entdecken Sie unsere Vorteile</a> "

- <span class="text_rose">20.000 Düfte und Beauty-Produkte</span>, die derzeit auf dem Gelände
- 500 Mark waren -40%, -50%, -70%
- € 3, € 8, <span class="text_rose">€ 15 Rabatt</span> angeboten
- <span Class="text_rose"> Porto € 3 </span> (von 2 insgesamt)
- 1 Geschenk <span class="text_rose"> HUGO BOSS angeboten </span> von 2 Produkte im Warenkorb
- Alle Online-Produkte sind ab <span class="text_rose">Lager</span> lieferbar
- <span class="text_rose">Zufrieden oder zurückerstattet</span> 30 Tage
- Sichere <span class="text_rose">Bezahlung</span>');
?>

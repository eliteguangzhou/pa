...
define('EMAIL_WELCOME', '¡Felicitaciones! Su cuenta personal ya está creado.

Ahora puede comprar nuestros perfumes, haga clic en "add to cart"

La información para acceder a su cuenta son:
...
define('ENTRY_EMAIL_ADDRESS_SPONSORSHIP_ERROR', 'La dirección de patrocinio es diferente de la que ha introducido.');

...
define('ACCOUNT_HISTORY_FACTURER', STORE_NAME.'<br />Una marca de Mercury Capital<br />New-York, Paris, Hong-Kong');

define('HEADER_TRACKING', '<b>Número de seguimiento  :</b>');
?>

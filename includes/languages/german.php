...
define('FOOTER_TEXT_BODY', ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a> &nbsp;&copy; ' . date('Y'));define('Our_Best_Candles', 'Nos meilleures bougies');
...
define('PRICE_TIMER', 1.20);

define('PAYEMENT_100_SECURE', '100% sichere Zahlung');
define('OUR_MARQUES','Einchecken');
?>

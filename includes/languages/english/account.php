...
define('MY_SPONSORSHIP_ADD', 'Sponsor a friend');
define('MY_SPONSORSHIP_LIST', 'Referrals');
define('MY_SPONSORSHIP_DISCOUNT', 'My discounts');
define('EXPIRATION_MEMBER', 'Your membership expires on %s.');
?>
...
define('EXPEDITION_TYPE_VALUE', 'USPS');
define('EXPEDITION_DELAY_LABEL', 'Delivery time');
define('EXPEDITION_DELAY_VALUE', 'Delivery 5 working days');
define('WARNING_NOT_SHIPPABLE', 'Warning ! Your delivery country is disabled.');
?>
...
<div id="pageHeader">
  <div>
    <div style="float: right; padding-top: 40px; padding-right: 15px; color: #000000; font-weight: bold;"><a href="http://www.oscommerce-fr.info" target="_blank">osCommerce Francophone</a> &nbsp;|&nbsp; <a href="http://www.oscommerce-fr.info/forum/" target="_blank">Support</a> &nbsp;|&nbsp; <a href="http://www.oscommerce.info" target="_blank">Documentation</a></div>

    <a href="index.php"><img src="images/oscommerce_silver-22.jpg" border="0" width="250" height="50" title="osCommerce Online Merchant v2.2" alt="osCommerce Online Merchant v2.2" style="margin: 10px 10px 0px 10px;" /></a>
  </div>
</div>

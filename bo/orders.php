...
?>
      ...
      <tr><td colspan="2"><?php echo tep_draw_form('status', FILENAME_ORDERS, tep_get_all_get_params(array('action')) . 'action=update_order'); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
        ...
        <td width="100%"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="right"><table border="0" summary="" width="100%" cellspacing="0" cellpadding="0">
              <tr><td colspan="2"><?php echo tep_draw_form('orders', FILENAME_ORDERS, '', 'get'); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
                <td class="smallText" align="right"><?php echo HEADING_TITLE_SEARCH . ' ' . tep_draw_input_field('oID', '', 'size="12"') . tep_draw_hidden_field('action', 'edit'); ?></td></tr></table>
              <?php echo tep_hide_session_id(); ?></form></td></tr>
              <tr><td colspan="2"><?php echo tep_draw_form('status', FILENAME_ORDERS, '', 'get'); ?><table border="0" summary="" width="100%" cellspacing="0" cellpadding="2"><tr>
                <td class="smallText" align="right"><?php echo HEADING_TITLE_STATUS . ' ' . tep_draw_pull_down_menu('status', array_merge(array(array('id' => '', 'text' => TEXT_ALL_ORDERS)), $orders_statuses), '', 'onChange="this.form.submit();"'); ?></td></tr></table>
              <?php echo tep_hide_session_id(); ?></form></td></tr>
            </table></td>
          </tr>
        </table></td>
